...
def demo_interactive_cli():
    ...
    print("🌐 API Features:")
    print("  • Uses OpenAI's whisper-1 model for transcription")
    print("  • GPT model selection for AI summaries (gpt-3.5-turbo, gpt-4, gpt-4-turbo)")
    ...
    print("1. 💡 gpt-3.5-turbo   2. 🚀 gpt-4   3. 🎯 gpt-4-turbo")
    print("Enter choice (1-3): 1")
    print()
